...
@ContextConfiguration(classes={RestoranController.class})
public class RestoranControllerTest {
    ...
    public void whenViewRestoranAccessItShouldShowRestoranData() throws Exception {
        ...
        newRestoran.setNama("Restoran Tester");
        newRestoran.setAlamat("alamat");
        newRestoran.setIdRestoran((long)1);
        newRestoran.setNomorTelepon(14000);

        when(restoranService.getRestoranByIdRestoran(1L)).thenReturn(Optional.of(newRestoran));
